...
namespace JPNut\ExtendedAuth\Testing;
...
abstract class TestCase extends BaseTestCase
{
    ...
    protected function setUpTraits()
    {
        ...
        if (isset($uses[\Illuminate\Foundation\Testing\DatabaseMigrations::class])) {
        ...
        if (isset($uses[\Illuminate\Foundation\Testing\WithoutMiddleware::class])) {
            $this->disableMiddlewareForAllTests();
        }

        if (isset($uses[\Illuminate\Foundation\Testing\WithoutEvents::class])) {
            $this->disableEventsForAllTests();
        }

        if (isset($uses[\Illuminate\Foundation\Testing\WithFaker::class])) {
            $this->setUpFaker();
        }
